  ...
  <div id="default-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
      <div class="relative p-4 w-full max-w-2xl max-h-full">
          ...
          <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
              ...
              <!-- Modal body -->
              <form method="POST" action="{{  route('users.store') }}" enctype="multipart/form-data" class="space-y-4 max-w-2xl mx-auto p-6 bg-white rounded-xl shadow">
                @csrf
                ...
                <div>
                    ...
                    <input type="text" name="lastname" value="{{ old('lastename', $user->lastname ?? '') }}" class="w-full border-gray-300 rounded-md shadow-sm">
                </div>
